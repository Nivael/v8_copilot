...
export interface EventNode { event_id:string; date:string; title:string; episode_type:string; episode_label:string; subtype_label:string; timeline_lane:string; timeline_label:string; provenance_refs:string[]; related_lens_ids:string[] }
